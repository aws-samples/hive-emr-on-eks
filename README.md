...
--job-driver '{
  "sparkSubmitJobDriver": {
      ...
      "sparkSubmitParameters": "--conf spark.jars.packages=org.mariadb.jdbc:mariadb-java-client:2.3.0 --conf spark.driver.cores=1 --conf spark.executor.memory=4G --conf spark.driver.memory=1G --conf spark.executor.cores=2"}}' \
